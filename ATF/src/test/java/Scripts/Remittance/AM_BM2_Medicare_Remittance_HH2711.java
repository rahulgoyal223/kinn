...
public class AM_BM2_Medicare_Remittance_HH2711 {
	


	/************************************************************************************
	'Class name                     : 	AM_BM2_Medicare_Remittance_HH2711
	'JIRA ID						:	HH-2711
	...
	public static void main(String[] args) throws Exception {
		AM_BM2_Medicare_Remittance_HH2711();
	}
	 @Test(groups = { "AM_Regression", "AM_Remittance" })
	public static void AM_BM2_Medicare_Remittance_HH2711() throws Exception {
	      
		/******************************************************************
		 * Mandate to call below lines at every test case start up
		 ******************************************************************/	
		//@Reports Configuration
			Report.generateReportsFile("html","AM_BM2_Medicare_Remittance_HH2711");
			Report.SetTestName("AM_BM2_Medicare_Remittance_HH2711","To Verify that user is able to create a new Remittance in Remittance Manager by clicking on the Remittance Manager link under Medicare/Managed Care section");
			...
			String dataFileName = "Remittance\\AM_BM2_Medicare_Remittance_HH2711.xlsx";
