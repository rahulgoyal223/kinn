...
public class AM_BM2_Medicare_Remittance_HH2588 {

	
	/************************************************************************************
	'Class name                     : 	AM_BM2_Medicare_Remittance_HH2588
	'JIRA ID						:	HH-2588
	'Description                    : 	To add External Adjustment to Remittance in Remittance Manager
	'Input Parameters           	: 	Remittance Number
	'Output Parameters        		: 	
	'Assumptions                    : 	Test Data is present in the Global Sheet.
	'Use                            : 	The following test verifies that user is able to add External Adjustment to Remittance in Remittance Manager
	'Tags                           : 	Regression
	 ************************************************************************************/
	
	public static void main(String[] args) throws Exception {
		AM_BM2_Medicare_Remittance_HH2588();
	}
	 @Test(groups = { "AM_Regression", "AM_Remittance" })
		public static void AM_BM2_Medicare_Remittance_HH2588() throws Exception {
		
				/******************************************************************
				 * Mandate to call below lines at every test case start up
				 ******************************************************************/	
				//@Reports Configuration
					Report.generateReportsFile("html","AM_BM2_Medicare_Remittance_HH2588");
					Report.SetTestName("AM_BM2_Medicare_Remittance_HH2588","To add External Adjustment to Remittance in Remittance Manager");
					...
					String dataFileName = "Remittance\\AM_BM2_Medicare_Remittance_HH2588.xlsx";
				...
				String Amt = AM.Billing.Remittance.RemittanceManager.txt_AR_ExternalAdjustment(driver).getAttribute("value");
