...
public class AM_BM2_Medicare_Remittance_HH30_HH4290 {

    /************************************************************************************
     'Class name                    : 	AM_BM2_Medicare_Remittance_HH30_HH4290
     'JIRA ID						:	HH-30
     'Description                   : 	Verify PPSClaimAgingBalance report after paying, adjusting, rejecting, and correcting an EOE
     'Input Parameters           	:
     'Output Parameters        		:
    ...
    public static void Test() throws Exception {
        ...
        Report.generateReportsFile("html", "AM_BM2_Medicare_Remittance_HH30_HH4290");
        Report.SetTestName("AM_BM2_Medicare_Remittance_HH30_HH4290", "Verify that EOE line item has same balance after the EOE has been rejected");
