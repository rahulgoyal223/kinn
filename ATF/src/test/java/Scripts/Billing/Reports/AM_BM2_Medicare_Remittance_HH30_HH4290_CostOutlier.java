...
import AM.Forms.PT.PTVisitsShortcut;
...
public class AM_BM2_Medicare_Remittance_HH30_HH4290_CostOutlier {

    /************************************************************************************
     'Class name                    : 	AM_BM2_Medicare_Remittance_HH30_HH4290_CostOutlier
     'JIRA ID						:	HH-30
     'Description                   : 	Verify PPSClaimAgingBalance report after paying, adjusting, rejecting, and correcting an EOE with 5 visits
     'Input Parameters           	:
     'Output Parameters        		:
     'Assumptions                   : 	Test Data is present in the Global Sheet.
     'Use                           : 	Verify that PBDR and PPS Claim Aging return the same balance after paying, adjusting, rejecting, and correcting an EOE for an episode with 5 visits
    ...
    public static void Test() throws Exception {
        ...
        Report.generateReportsFile("html", "AM_BM2_Medicare_Remittance_HH30_HH4290_CostOutlier");
        Report.SetTestName("AM_BM2_Medicare_Remittance_HH30_HH4290_CostOutlier", "Verify that PBDR and PPS Claim Aging return the same balance after paying, adjusting, rejecting, and correcting an EOE for an episode with 5 visits");
        ...
        String dataFileName = "Billing.Reports\\AM_BM2_Medicare_PPSClaimsAgingReport_HH30_HH4290_CostOutlier.xlsx";
        ...
        //@ Step add 50 visits and complete them
        int numberOfVisitsToComplete = 50;
        Datatable.loadDataSheet(dataFileName, "AM_VerifyPTVisitTemplate");
        Date today = new Date();
        PTVisitsShortcut.CompletePTVisits(driver, today, numberOfVisitsToComplete);
