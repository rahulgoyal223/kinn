...
public class AM_BM2_Medicare_Remittance_HH30_HH4290_EoeRefreshed {

    /************************************************************************************
     'Class name                    : 	AM_BM2_Medicare_Remittance_HH30_HH4290_EoeRefreshed
     'JIRA ID						:	HH-30
     'Description                   : 	Verify PPSClaimAgingBalance report after paying, adjusting, rejecting, and correcting and refreshing an EOE
     'Input Parameters           	:
     'Output Parameters        		:
    ...
    public static void Test() throws Exception {
        ...
        Report.generateReportsFile("html", "AM_BM2_Medicare_Remittance_HH30_HH4290_EoeRefreshed");
        Report.SetTestName("AM_BM2_Medicare_Remittance_HH30_HH4290_EoeRefreshed", "Verify PPSClaimAgingBalance report after paying, adjusting, rejecting, and correcting and refreshing an EOE");
