...
public class AM_BM2_Medicare_Remittance_HH30_HH4290_NonLUPA {

    /************************************************************************************
     'Class name                    : 	AM_BM2_Medicare_Remittance_HH30_HH4290_NonLUPA
     'JIRA ID						:	HH-30
    ...
    public static void Test() throws Exception {
        ...
        Report.generateReportsFile("html", "AM_BM2_Medicare_Remittance_HH30_HH4290_NonLUPA");
        Report.SetTestName("AM_BM2_Medicare_Remittance_HH30_HH4290_NonLUPA", "Verify that PBDR and PPS Claim Aging return the same balance after paying, adjusting, rejecting, and correcting an EOE for an episode with 5 visits");
        ...
        //@ Step add 5 visits and complete them
        for (int i = 1; i <= 5; i++) {
