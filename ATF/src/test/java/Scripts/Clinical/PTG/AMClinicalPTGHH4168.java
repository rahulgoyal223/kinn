...
public class AMClinicalPTGHH4168 {
	
	/************************************************************************************
	'Class name                     : 	AMClinicalPTGHH4168
	'JIRA ID						:	HH-4168
	'Description                    : 	Verify the attachment of more than one Intervention to a Goal.
	...
	public void test() throws Exception {
		...
		Report.SetTestName("AM_Patient_HH4168","To Verify the attachment of more than one Intervention to a Goal");
		...
		//Add two interventions to be sure we have at least 2 interventions to add to the goal
		for (int i = 0; i < 2; i++) {
			interventionPage.getBtnInterventions(driver).click();
			interventionPage.getBtnNewIntervention(driver).click();
			interventionPage.getTxtInterventionName(driver).sendKeys("Intervention Automation  HH4168 "+NumberUtil.getRandomNumber());
		...
		btnNewGoal.click();
		goalPage.getTxtGoalName(driver).sendKeys("Goal Automation HH4168 "+NumberUtil.getRandomNumber());
		...
		interventionsFromDialog.get(1).click();
