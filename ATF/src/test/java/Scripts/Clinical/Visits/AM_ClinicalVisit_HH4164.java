...
public class AM_ClinicalVisit_HH4164 {

	/************************************************************************************
		'Class name                     : 	AM_ClinicalVisit_HH4164
		'JIRA ID						:	HH-4164
		'Description                    : 	To Verify the user can't create/edit Nonstandard Dosage Medication with Longstanding and the 
											Change/New flags enabled at the same time	
		'Input Parameters           	: 	Patient Name
		'Output Parameters        		: 	
		'Assumptions                    : 	Test Data is present in the Global Sheet.
		'Use                            : 	The following test verifies the user can't create/edit Nonstandard Dosage Medication with 
											Longstanding and the Change/New flags enabled at the same time	
		'Tags                           : 	Regression, Smoke Test, E2E
	 ************************************************************************************/
	public static void main(String[] args) throws Exception {
		AM_ClinicalVisit_HH4164();
	}

	@Test(groups = { "AM_Regression", "AM_Clinical" })
	public static void AM_ClinicalVisit_HH4164() throws Exception {
		String dataSheetName = null;
		String PM_PatientName = null;
		//@Reports Configuration			
		Report.generateReportsFile("html","AM_ClinicalVisit_HH4164");
		Report.SetTestName("AM_ClinicalVisit_HH4164", "To Verify the user can't create/edit Nonstandard Dosage Medication with Longstanding and the "
				+ "Change/New flags enabled at the same time");
		...
		dataSheetName = "AM_BM2_MedicationProfile_HH4164";
