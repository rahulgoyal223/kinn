...
public class AM_ClinicalVisit_HH3933 {

	/************************************************************************************
	'Class name              : 	AM_ClinicalVisit_HH3933
	'JIRA ID				 :	HH-3933
	 ...
	 ************************************************************************************/
   	...
   	public static void main(String[] args) throws Exception {
   		AM_ClinicalVisit_HH3933();
	 }
	
   	 @Test(groups = { "AM_Regression", "AM_Clinical" })
	 public static void AM_ClinicalVisit_HH3933() throws Exception {
       ...
       ******************************************************************/
       ...
       Report.generateReportsFile("html","AM_ClinicalVisit_HH3933");
       Report.SetTestName("AM_ClinicalVisit_HH3933", "To verify  M2005 displays option Not assessed/No Information");       
      ...
      //@Open Application and submit credentials
       ...
       String dataFileName = "Clinical\\ClinicalVisit\\AM_ClinicalVisit_HH3933.xlsx";
      ...
      //@@Step :To create new patient
		...
		//@ Step -  :To navigate to patient manager
 		Datatable.loadDataSheet(dataFileName, "AM_CV_OASISC2Transfer_HH3933");
        Datatable.setCurrentRow(1);
             
		//@ Step -  :To select and schedule a Task 
	    AM.Episode.EpisodeManager.SelectTaskTab(driver,"Nursing");
	    AM.Episode.EpisodeManager.AddScheduleTasks(driver);
        AM.Episode.EpisodeManager.SelectScheduleTasks(driver, "OASIS-C2 Transfer");
      ...
      //@Step Run Oasis check screen
       ...
       AM.Forms.Nursing.OasisTransfer.VerifyM2005Options(driver);       
