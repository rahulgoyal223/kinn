...
public class AM_BM2_Medicare_RAP_HH2514 {

	/************************************************************************************
	'Class name                     : 	AM_BM2_Medicare_RAP_HH2514
	'JIRA ID						:	HH-2514
	'Description                    : 	To move a Rap claim from Pending Payment tab to Paid Tab
	...
	'Use                            : 	The following test verifies that the user is able
										to move a Rap claim from Pending Payment tab to Paid Tab
	'Tags                           : 	Regression, SmokeTest	
	 ************************************************************************************/

	public static void main(String[] args) throws Exception {
		AM_BM2_Medicare_RAP_HH2514();

	}
	
	@Test//FIXME(groups = { "AM_BM2_Claims", "AM_Regression" })
	public static void AM_BM2_Medicare_RAP_HH2514() throws Exception {
      ...
      Report.generateReportsFile("html","AM_BM2_Medicare_RAP_HH2514");
      Report.SetTestName("AM_BM2_Medicare_RAP_HH2514", "Verify To move a Rap claim from Pending Payment tab to Paid Tab");
     ...
     //@Import Test data sheet
      String dataFileName = "Claims\\Medicare\\AM_BM2_Medicare_RAP_HH2514.xlsx";
      dataSheetName = "AM_BM2_Medicare_RAP_HH2514";
     ...
     //@@Step :To create new patient if needed
      ...
      //@Step - : To Select the Billing Manager
        ...
        Datatable.loadDataSheet(dataFileName, "AM_BM2_Medicare_RAP_HH2514");
