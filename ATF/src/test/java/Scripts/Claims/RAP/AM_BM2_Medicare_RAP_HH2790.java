...
public class AM_BM2_Medicare_RAP_HH2790 {

	/************************************************************************************
	'Class name                     : 	AM_BM2_Medicare_RAP_HH2790
	'JIRA ID						:	HH-2790
	'Description                    : 	To Verify First Billable Visit status when Billable
										visit is completed and non billable visit is incomplete
										are scheduled different days with the same visit date
	...
	public static void main(String[] args) throws Exception {
		AM_BM2_Medicare_RAP_HH2790();
	}
		
		@Test(groups = { "AM_BM2_Claims", "AM_Regression" })
		public static void AM_BM2_Medicare_RAP_HH2790() throws Exception {
	    	String PM_PatientName = null;
	        /******************************************************************
	         * Mandate to call below lines at every test case start up
	         ******************************************************************/
		//@Reports Configuration			
	    Report.generateReportsFile("html","AM_BM2_Medicare_RAP_HH2790");
	    Report.SetTestName("AM_BM2_Medicare_RAP_HH2790", "Verify First Billable Visit status in RAP Pending creation claim page when first billable is completed and non billable visit is incomplete which are scheduled different days but the visit date is same");
		...
		String dataFileName = "Claims\\Medicare\\AM_BM2_Medicare_RAP_HH2790.xlsx";
		String dataSheetName = "AM_BM2_Medicare_RAP_HH2790";
