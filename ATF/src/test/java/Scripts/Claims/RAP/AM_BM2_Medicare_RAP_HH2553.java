...
public class AM_BM2_Medicare_RAP_HH2553 {


	/************************************************************************************
	'Class name                     : 	AM_BM2_Medicare_RAP_HH2553
	'JIRA ID						:	HH-2553
	'Description                    : 	Verify that a user can delete RAP Claim from Remittance.
	'Input Parameters           	: 	Patient Name, Claim Number, MRN
	'Output Parameters        		: 	
	'Assumptions                    : 	Test Data is present in the Global Sheet.
	'Use                            : 	The following test verifies the delete RAP Claim from Remittance.
	'Tags                           : 	Regression
	 ************************************************************************************/
	
	public static void main(String[] args) throws Exception {
		AM_BM2_Medicare_RAP_HH2553();
	}
		
	@Test(groups = { "AM_BM2_Claims", "AM_Regression" })
	public static void AM_BM2_Medicare_RAP_HH2553() throws Exception {

		
	String PM_PatientName = null;	
    String dataSheetName = null;
    
    Report.generateReportsFile("html","AM_BM2_Medicare_RAP_HH2553");
    Report.SetTestName("AM_BM2_Medicare_RAP_HH2553", "Delete Remittance which has RAP claim");
    Report.assignCategory("RAP");
    AM.Login.openAppAndSubmitCredentials();
    WebDriver driver = Browser.getDriver();
    String dataFileName = "Claims\\Medicare\\AM_BM2_Medicare_RAP_HH2553.xlsx";
    dataSheetName = "AM_BM2_RAP_100554";
   ...
   /*****************************************************************/
	...
	Waits.ForElementVisibility(driver, AM.Forms.Nursing.OasisSOC.txt_PD_M1021_PrimaryDiagnosis(driver));
   ...
   AM.Billing.Claims.ClaimsManager.VerifyAlertmessage(driver, "Palmetto GBA: Claim(s) have been generated successfully and can be reviewed in the Pending Payment tab.");
	...
	if(!GlobalData.getPatientMRNumber().isEmpty()){
	 ...
	 Waits.ForBrowserLoad(driver);
	 AM.Billing.Remittance.RemittanceManager.icon_AR_Delete(driver).click();
	 Verify.VerifyElementNotPresent(AM.Billing.Remittance.RemittanceManager.btn_AR_ExpandClaimDetails(driver));
