...
public class AM_BM2_Medicare_RAP_HH2675 {


		/************************************************************************************
		'Class name                     : 	AM_BM2_Medicare_RAP_HH2675
		'JIRA ID						:	HH-2675
		'Description                    : 	To Verify user is able to Edit Comment in the RAP claim
		'Input Parameters           	: 	Patient Name, Claim Number, MRN
		'Output Parameters        		: 	
		'Assumptions                    : 	Test Data is present in the Global Sheet.
		'Use                            : 	The following test verifies user is able to Edit Comment in the RAP claim
		'Tags                           : 	Regression, Smoke Test, E2E
		 ************************************************************************************/
	//TODO comeback to debug or find a better way to execute this scenario	
	    ...
	    Report.generateReportsFile("html","AM_BM2_Medicare_RAP_HH2675");
	    Report.SetTestName("AM_BM2_Medicare_RAP_HH2675", "Verify user is able to Edit Comment in the RAP claim");
	    Report.assignCategory("RAP");
	    AM.Login.openAppAndSubmitCredentials();
	    WebDriver driver = Browser.getDriver();
	    String dataFileName = "Claims\\Medicare\\AM_BM2_Medicare_RAP_HH2675.xlsx";
	    dataSheetName = "AM_BM2_RAP_HH2675";
	   ...
	   /*****************************************************************/
	    ...
	    if(Datatable.GetValue("CMS485Check").equals("Yes")){
	      ...
	      Waits.ForElementVisibility(driver, AM.Billing.Claims.ClaimsManager.btn_PA_Approve(driver));
		...
		Waits.ForElementVisibility(driver, AM.Billing.Remittance.RemittanceManager.btn_AR_SaveandComplete(driver));
		...
		Datatable.loadDataSheet(dataFileName, "AM_BM2_RAP_HH2675");
		AM.Menu.TopMenu.Select(driver,"Go To/Billing Manager");
		...
		AM.Billing.Claims.ClaimsManager.RS_SelectPatient(driver, PM_PatientName);
		AM.Billing.Claims.ClaimsManager.clk_greenicon(driver).click();
		AM.Billing.Claims.ClaimsManager.txt_AC_AddComment(driver).sendKeys(Datatable.GetValue("AC_AddComment"));
	    AM.Billing.Claims.ClaimsManager.btn_AC_SaveComment(driver).click();
