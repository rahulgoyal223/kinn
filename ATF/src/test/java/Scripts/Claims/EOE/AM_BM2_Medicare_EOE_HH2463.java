...
public class AM_BM2_Medicare_EOE_HH2463 {

	/************************************************************************************
	'Class name                     : 	AM_BM2_Medicare_EOE_HH2463
	'ID								:	HH-2463
	'Description                    : 	Verify that user is able to Add Document Control Number
	'Input Parameters           	: 	Patient Name, Claim Number, MRN
	'Output Parameters        		: 	
	'Assumptions                    : 	Test Data is present in the Global Sheet.
	'Use                            : 	To Verify that user is able to Add Document Control Number
	'Tags                           : 	Regression
	 ************************************************************************************/
	...
	*****************************************************************/
    ...
    Report.generateReportsFile("html","AM_BM2_Medicare_EOE_HH2463");
    Report.SetTestName("AM_BM2_Medicare_EOE_HH2463", "Verify that user is able to Add Document Control Number");
   ...
   /*****************************************************************/
		...
		Thread.sleep(Waits.getSleepLevelFive());
		AM.Billing.Claims.UB04_Worksheet.txt_WS_DCN(driver).clear();
		AM.Billing.Claims.UB04_Worksheet.txt_WS_DCN(driver).sendKeys(Datatable.GetValue("DCN"));
		Thread.sleep(Waits.getSleepLevelFive());	   
