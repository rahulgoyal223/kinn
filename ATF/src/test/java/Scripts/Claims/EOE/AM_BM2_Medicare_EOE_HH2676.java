...
public class AM_BM2_Medicare_EOE_HH2676 {

	/************************************************************************************
	'Class name                     : 	AM_BM2_Medicare_EOE_HH2676
	'JIRA ID						:	HH-2676
	'Description                    : 	Verify that LUPA amount is displayed in EOE claim worksheet
	'Input Parameters           	: 	Patient Name, Claim Number, MRN
	'Output Parameters        		: 	
	'Assumptions                    : 	Test Data is present in the Global Sheet.
	'Use                            : 	The following test verifies the LUPA amount is displayed in EOE claim worksheet
	'Tags                           : 	Regression
	 ************************************************************************************/
	 ...
	 ******************************************************************/	
    Report.generateReportsFile("html","AM_BM2_Medicare_EOE_HH2676");
    Report.SetTestName("AM_BM2_Medicare_EOE_HH2676", "AM_82721_Claims Manager_EOE_Verify LUPA amount is displayed in EOE Claims Worksheet");
    Report.assignCategory("EOE");
    AM.Login.openAppAndSubmitCredentials();
    WebDriver driver = Browser.getDriver();
    String dataFileName = "Claims\\Medicare\\AM_BM2_Medicare_EOE_HH2676.xlsx";
    dataSheetName = "AM_BM2_EOE_82721";
		...
		if(!GlobalData.getPatientMRNumber().isEmpty()){
		 ...
		 if(!GlobalData.getPatientMRNumber().isEmpty()){
			...
			if(!GlobalData.getPatientMRNumber().isEmpty()){
			 ...
			 AM.Billing.Claims.HCFA_1500_08_05ClaimWorksheet.verifyEOEClaim(driver,5, 8, 2);
