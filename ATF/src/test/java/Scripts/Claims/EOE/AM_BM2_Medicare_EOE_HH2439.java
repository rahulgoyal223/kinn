...
public class AM_BM2_Medicare_EOE_HH2439 {


	/************************************************************************************
	'Class name                     : 	AM_BM2_Medicare_EOE_HH2439
	'JIRA ID						:	HH-2439
	'Description                    : 	Verify that user is able to create an EOE claim
	'Input Parameters           	: 	Patient Name, Claim Number, MRN
	'Output Parameters        		: 	
	'Assumptions                    : 	Test Data is present in the Global Sheet.
	'Use                            : 	The following test verifies that user is able to create an EOE claim
	'Tags                           : 	Regression
	 ************************************************************************************/
    ...
    Report.generateReportsFile("html","AM_BM2_Medicare_EOE_HH2439");
    Report.SetTestName("AM_BM2_Medicare_EOE_HH2439", "Verify that user is able to create an EOE claim");
    Report.assignCategory("EOE");
    AM.Login.openAppAndSubmitCredentials();
    WebDriver driver = Browser.getDriver();
    String dataFileName = "Claims\\Medicare\\AM_BM2_Medicare_EOE_HH2439.xlsx";
    dataSheetName = "AM_BM2_EOE_HH2439";
    ...
    if(Datatable.GetValue("CMS485Check").equals("Yes")){
	   ...
	   AM.Billing.Claims.ClaimsManager.VerifyAlertmessage(driver, "Palmetto GBA: Claim(s) have been generated successfully and can be reviewed in the Pending Payment tab.");
		...
		if(!GlobalData.getPatientMRNumber().isEmpty()){
		 ...
		 Datatable.loadDataSheet(dataFileName, "AM_BM2_EOE_HH2439");
		 AM.Menu.TopMenu.Select(driver,"Go To/Billing Manager");
