...
public class AM_BM2_ManagedCare_HH2513 {

	/************************************************************************************
	'Class name                     : 	AM_BM2_ManagedCare_HH2513
	'JIRA ID						:	HH-2513
	'Description                    : 	Verify that claim is available in Pending Approval tab when it is Adjusted from Paid tab
	'Input Parameters           	: 	Patient Name, Claim Number, MRN
	'Output Parameters        		: 	Patient
	'Assumptions                    : 	Test Data is present in the Global Sheet.
	'Use                            : 	The following test verifies that claim is available in Pending Approval tab when it is Adjusted from Paid tab
	'Tags                           : 	Regression
	 ************************************************************************************/
      ...
      Report.generateReportsFile("html","AM_ManagedCare_HH2513");
      Report.SetTestName("AM_ManagedCare_HH2513", "Verify that claim is available in Pending Approval tab when it is Adjusted from Paid tab");
     ...
     //@Import Test data sheet
      String dataFileName = "Claims\\ManagedCare\\AM_BM2_ManagedCare_HH2513.xlsx";
      dataSheetName = "AM_ManagedCare_86038";
     ...
     //**********************************************************************
      ...
      //@Step - Approve CMS 485 form
        ...
        Thread.sleep(Waits.getSleepLevelFive());
        Datatable.loadDataSheet(dataFileName, "AM_ManagedCare_86038");
		...
		AM.Billing.Claims.ClaimsManager.btn_PD_Adjust(driver).click();
		...
		AM.Billing.Claims.ClaimsManager.VerifyAlertmessage(driver, "Claim(s) marked as adjusted and returned to the Pending Approval tab.");
