...
public class AM_BM2_ManagedCare_HH2754 {


	/************************************************************************************
	'Class name                     : 	AM_BM2_ManagedCare_HH2754
	'JIRA ID						:	HH-2754
	'Description                    : 	To Verify that claim is available in Claims Manager: Secondary Managed Care- Pending Payment tab after the user clicks on Resend Manually option.
	'Input Parameters           	: 	Patient Name, MRN
	'Output Parameters        		: 	Patient Name,MRN
	'Assumptions                    : 	Test Data is present in the Global Sheet.
	'Use                            : 	The following test verifies the functionality of Verify that claim is available in Claims Manager: Secondary Managed Care- Pending Payment tab after the user clicks on Resend Manually option
	...
	public static void main(String[] args) throws Exception {
	    ...
	    Report.generateReportsFile("html","AM_BM2_ManagedCare_HH2754");
	    Report.SetTestName("AM_BM2_ManagedCare_HH2754", "AM_84367_Claims Manager_MCS_Verify that claim is available in Claims Manager: Secondary Managed Care- Pending Payment tab after the user clicks on Resend Manually option");
	    Report.assignCategory("ManagedCare");
	    AM.Login.openAppAndSubmitCredentials();
	    WebDriver driver = Browser.getDriver();
	    String dataFileName = "Claims\\ManagedCare\\AM_BM2_ManagedCare_HH2754.xlsx";
	    dataSheetName = "AM_BM2_MC_84367";
     	...
     	if(!GlobalData.getPatientMRNumber().isEmpty())
		  ...
		  if(!GlobalData.getPatientMRNumber().isEmpty()) {
	       ...
	       if(!GlobalData.getPatientMRNumber().isEmpty())
            ...
            //@Step -Resend Manually claim in Pending Payment tab 
			Thread.sleep(Waits.getSleepLevelFive());
	     	AM.Billing.Claims.ClaimsManager.SelectStatusTab(driver, "Pending Payment");
