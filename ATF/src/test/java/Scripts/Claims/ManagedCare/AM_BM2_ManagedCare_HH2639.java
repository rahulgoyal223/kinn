...
public class AM_BM2_ManagedCare_HH2639 {
	/************************************************************************************
	'Class name                     : 	AM_BM2_ManagedCare_HH2639
	'JIRA ID						:	HH-2639
	'Description                    : 	To verify that user is able to reject a claim in managed care
	'Input Parameters           	: 	Patient Name, MRN
	'Output Parameters        		: 	Patient Name,MRN
	'Assumptions                    : 	Test Data is present in the Global Sheet.
	'Use                            : 	The following test verifies the functionality of user is able to that user is able to Verify User can reject a claim in managed care
	'Tags                           : 	Smoke Test
	 * @throws Exception 
	 ************************************************************************************/
	...
	public static void Test() throws Exception {
	    ...
	    Report.generateReportsFile("html","AM_BM2_ManagedCare_HH2639");
	    Report.SetTestName("AM_BM2_ManagedCare_HH2639", "Verify the functionality of EDI file of a patient for the Primary payer under Managed care in BM2");
	    Report.assignCategory("ManagedCare");
	    AM.Login.openAppAndSubmitCredentials();
	    WebDriver driver = Browser.getDriver();
	    String dataFileName = "Claims\\ManagedCare\\AM_BM2_ManagedCare_HH2639.xlsx";
	    dataSheetName = "AM_BM2_MC_HH2639";
