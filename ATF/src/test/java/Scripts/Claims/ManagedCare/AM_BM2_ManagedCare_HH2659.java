...
public class AM_BM2_ManagedCare_HH2659 {

	/************************************************************************************
	'Class name                     : 	AM_BM2_ManagedCare_HH2659
	'JIRA ID						:	HH-2659
	'Description                    : 	To Verify user is able to approve claims and
										validate data integrity
	'Input Parameters           	: 	Patient Name
	'Output Parameters        		: 	
	'Assumptions                    : 	Test Data is present in the Global Sheet.
	'Use                            : 	The following test verifies that the user is able
										approve managed care claims using primary payer and
										validate the data displayed in Ready To Send tab
	'Tags                           : 	Regression, Smoke Test, E2E
	 ************************************************************************************/
	
	public static void main(String[] args) throws Exception {
		AM_BM2_ManagedCare_HH2659();
	}
		
		@Test(groups = { "AM_BM2_Claims", "AM_Regression" })
		public static void AM_BM2_ManagedCare_HH2659() throws Exception {
    	//@Reports Configuration
		String dataSheetName = null;
	    String PM_PatientName = null;
    	Report.generateReportsFile("html","AM_BM2_ManagedCare_HH2659");
		Report.SetTestName("AM_BM2_ManagedCare_HH2659","To Verify User can able to approve claims and verify data in Ready To Send");
		...
		//@Import Test data sheet
		 ...
		 String dataFileName = "Claims\\ManagedCare\\AM_BM2_ManagedCare_HH2659.xlsx";
	     dataSheetName = "AM_BM2_MC_Claims_HH2659";
	     Datatable.loadDataSheet(dataFileName, dataSheetName);
	     //PM_PatientName = "Boult455, Jazz";
	     //RD_MrecordNumber = "Null";
	      //**********************************************************************	          
			        ...
			        Datatable.GetValue("PM_PatientName");
			            ...
			            Datatable.loadDataSheet(dataFileName, "AM_BM2_MC_Claims_HH2659");				      
						...
						//@Step - To verify the patient name
