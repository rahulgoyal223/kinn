...
public class RemittanceManager {
	...
	public static void goToNewRemittance(WebDriver driver) {
		driver.get(Config.getAppUrl() + "/EHR/#/HM/billing/remittance/new");
	}
	...
	private static void SelectAdjustmentReason(WebDriver driver,
			String Adjreason) throws InterruptedException {
		Events.Fire(driver).moveToElement(cmb_AR_AdjustmentReason(driver)).click().perform();
		Events.Fire(driver)
	...
	public static List<WebElement> txt_AR_Payment_List(WebDriver driver) {
	...
	public static WebElement cmb_AR_AdjustmentReasonSearchProvider(WebDriver driver) {
		element = driver
				.findElement(By
						.xpath("/html/body/div[11]/div/input"));
		return element;
	}
	...
	public static WebElement cmb_AR_AdjustmentReasonSearchExternal(WebDriver driver) {
		element = driver
				.findElement(By
						.xpath("/html/body/div[12]/div/input"));
		return element;
	}
